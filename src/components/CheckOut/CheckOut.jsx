...
const CheckOut = () => {
    ...
    const { details, image_url, title, price, name, category, overview } = checkOutItem;
    return (
        <>
                ...
                <div className="p-6 py-12 bg-emerald-100 dark:bg-violet-400 dark:text-gray-900">
                    <div className="container mx-auto">
                        <div className="flex flex-col lg:flex-row items-center justify-between">
                            <h2 className="text-center text-4xl lg:text-6xl tracking-tighter font-bold">CheckOut : {name}</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="additional_info bg-emerald-100 col-span-12 lg:col-span-8 shadow-sm">
                        <form action="#">
                            ...
                            <div className="btn_area flex justify-end">
                                <button className='py-3 mb-10 px-10 mr-6 bg-emerald-400 hover:bg-emerald-500 text-white rounded-sm dark:text-gray-900 dark:bg-violet-400'>Place Order</button>
                            </div>
                        </form>
                    </div>
                </div>
